...
CREATE CONSTANT DRIVER_ACTIVE_UNAVAILABLE_ID VALUE '51274d4b-846f-4624-83ea-1ef56d61bb60';
CREATE CONSTANT DRIVER_GORAN_ID VALUE 'ef3b16c7-8f59-4cae-97c8-1f6aea8d54a7';
...
CREATE CONSTANT PASSENGER_JOVAN_ID VALUE 'ad287b0c-3436-4445-ab81-f3aa89423fd6';
...
CREATE CONSTANT PASSENGER_IVAN_ID VALUE 'e0699785-4afc-4eb4-abd9-3ff0864e48b8';
CREATE CONSTANT PASSENGER_IGOR_ID VALUE '4c89d37d-b530-41b8-a006-bea8f89eddc4';
...
create constant RIDE_9 value 'd39e89f1-0fea-49d3-a440-b7f6f2538100';
create constant RIDE_10 value '5979bae2-efde-40a7-8c59-c9b20c5dcfb2';
...
create constant RIDE_107 value '412748b0-454f-4cac-8ab6-1388f9eebc19';
...
('8373d6bd-fc57-4298-a073-32fc92996451', 45.246, 19.8512, FALSE, TRUE, 4, '7b4f82de-8e90-47eb-bae6-be020c45df31'),
...
(PASSENGER_IVAN_ID, 'ivan.ivanovic@gmail.com', TRUE, NULL, 'Ivan Ivanovic', '$2a$10$Qg.gpYTtZiVMJ6Fs9QbQA.BtCx4106oSj92X.A/Gv7iAEKQXAg.gy', 'local', NULL, 'ROLE_PASSENGER','Novi Sad', 'Ivan', 'Ivanovic', '+3816455555', '10000', FALSE, ''),
(PASSENGER_JOVAN_ID, 'jovan.jovanovic@gmail.com', TRUE, NULL, 'Jovan Jovanovic', '$2a$10$Qg.gpYTtZiVMJ6Fs9QbQA.BtCx4106oSj92X.A/Gv7iAEKQXAg.gy', 'local', NULL, 'ROLE_PASSENGER','Novi Sad', 'Jovan', 'Jovanović', '+381891723', '1', FALSE, ''),
(PASSENGER_IGOR_ID, 'igor.igoric@gmail.com', TRUE, NULL, 'Igor Igoric', '$2a$10$Qg.gpYTtZiVMJ6Fs9QbQA.BtCx4106oSj92X.A/Gv7iAEKQXAg.gy', 'local', NULL, 'ROLE_PASSENGER','Novi Sad', 'Igor', 'Igoric', '+38189012380', '10000', FALSE, ''),
...
INSERT INTO RIDE (ID, FARE, DRIVER_ID, START_TIME, END_TIME, RIDE_STATUS, DISTANCE, ESTIMATED_TIME) VALUES
    ...
    (RIDE_9, 1000.0, DRIVER_ACTIVE_UNAVAILABLE_ID, '2023-05-27 11:05:29.267235', '2023-05-27 11:25:29.267235', 2, 100, 20),
	(RIDE_10, 1000.0, DRIVER_ACTIVE_UNAVAILABLE_ID, '2023-05-27 11:05:29.267235', '2023-05-27 11:25:29.267235', 5, 100, 20),
    (RIDE_107, 3000.0, null, null, null, 0, 200, 20);
...
(RIDE_107, PASSENGER_JOVAN_ID),
(RIDE_107, PASSENGER_IGOR_ID);

INSERT INTO RIDE_PASSENGERS_READY (RIDE_ID, PASSENGERS_READY) VALUES
(RIDE_107, 0),
(RIDE_107, 1);
